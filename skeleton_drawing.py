"""
Part 2 — رسم الـ Skeleton الملون فوق الفيديو (cyan=lead, orange=trail, green=spine)
"""
import cv2

import config
from geometry_engine import midpoint
...
def draw_skeleton(frame, image_landmarks):
    """يرسم الأرجل والعمود الفقري فوق الفريم. بيرجع الفريم زي ما هو لو مفيش جسم مكتشف."""
    if image_landmarks is None:
        return frame

    for chain, color in [(config.LEAD_CHAIN, config.COLOR_LEAD),
